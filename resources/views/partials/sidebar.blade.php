    ...
    <div class="page-sidebar navbar-collapse collapse">
        <ul class="page-sidebar-menu"
            ...
            <li>
                ...
                <ul class="sub-menu">
                    <li class="{{ $request->segment(1) == 'jpnews' ? 'active active-sub' : '' }}">
                        <a href="{{ route('jpnews.index') }}">
                            <i class="fa fa-gears"></i>
                            <span class="title">Japan News</span>
                        </a>
                    </li>
                    <li class="{{ $request->segment(1) == 'kornews' ? 'active active-sub' : '' }}">
                        <a href="{{ route('kornews.index') }}">
                            <i class="fa fa-gears"></i>
                            <span class="title">Korean News</span>
                        </a>
                    </li>
                </ul>
            </li>
        ...
        <div class="text-center margin-top-20" style="color: white">
            Quiz | WePop is powered by
            <br />
            <a href="https://instagram.com/arrizal27" target="_blank">www.bridge.com</a>

            <br /><br />

            Feedback/questions?
            <br />
            <a href="mailto:info@laraveldaily.com" target="_blank">info@brigde.com</a>
        </div>
    </div>
</div>
